...
import AwaitSchedule from "../AwaitSchedule";

const BACKEND_URL = process.env.REACT_APP_BACKEND_URL;
const API_URL = `${BACKEND_URL}/api/users/`;

const AwaitScheduleEvent = () => {
  ...
  return <AwaitSchedule events={fetchEvents} loading={loading} />;
};

export default AwaitScheduleEvent;
